...
class ChatBotPage extends StatefulWidget {
  ...
  ChatBotPage({String topicClass:'', String topicName:''}) {
    this.topicClass = topicClass;
    this.topicName = topicName;
  }

  @override
  _ChatBotPage createState() => new _ChatBotPage(topicClass:topicClass, topicName:topicName);
}
...
class _ChatBotPage extends State<ChatBotPage> {
  ...
  _ChatBotPage({String topicClass:'', String topicName:''}) {
