...
import '../sels_app_home_screen.dart';
import '../setting/setting_screen.dart';
import '../ui_view/body_measurement.dart';
import '../ui_view/glass_view.dart';
import '../ui_view/mediterranean_diet_view.dart';
import '../ui_view/buttonCard_view.dart';
import '../ui_view/title_view.dart';
import '../sels_app_theme.dart';
import '../homepage/class_list_view.dart';
import '../homepage/water_view.dart';
import 'package:flutter/material.dart';
import '../phoneticExercises/phoneticExercises_screen.dart';

class HomePageScreen extends StatefulWidget {
  const HomePageScreen({Key? key, this.updateCounter, this.animationController}) : super(key: key);
  final updateCounter;
  ...
  void addAllListData() {
    ...
    listViews.add(
      TitleView(
        ...
        subVisivle: true,
        subFunction: (){
          Navigator.push(context, MaterialPageRoute(builder: (context) => TopicListScreen(animationController: widget.animationController)));
        },
      ),
    );
