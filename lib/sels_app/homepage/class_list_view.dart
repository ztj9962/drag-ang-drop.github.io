...
import '../models/sentenceTypes_list_data.dart';
import '../../main.dart';
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            GestureDetector(
                              onTap: (){
                                if(showIndex == ''){
                                  Navigator.push(context, MaterialPageRoute(builder: (context) => ChatBotPage(topicClass:sentenceTypesListData!.titleTxt)));
                                } else {
                                  Navigator.push(context, MaterialPageRoute(builder: (context) => ChatBotPage(topicName:sentenceTypesListData!.titleTxt)));
                                }
                                },
