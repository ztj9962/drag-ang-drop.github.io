...
import '../page/learning/learning_auto_generic_summary_report_page.dart'
    as _i14;
import '../page/learning/learning_auto_minimal_pair_page.dart' as _i15;
import '../page/learning/learning_manual_custom_article_practice_sentence_page.dart'
    as _i16;
import '../page/learning/learning_manual_minimal_pair_page.dart' as _i17;
...
import '../page/preference_translations/preference_sentence_search.dart'
    as _i20;
import '../page/sentence_analysis/sentence_analysis_index_page.dart' as _i22;
...
import '../page/vocabulary_practice_word/vocabulary_practice_word_list_page.dart'
    as _i7;
import '../page/vocabulary_test/vocabulary_test_index_page.dart' as _i10;
import '../page/vocabulary_test/vocabulary_test_questing_page.dart' as _i11;
import '../page/vocabulary_test/vocabulary_test_report_page.dart' as _i12;
...
class AppRouter extends _i23.RootStackRouter {
  ...
  final Map<String, _i23.PageFactory> pagesMap = {
    ...
    CustomArticlePracticeSentenceIndexRoute.name: (routeData) {
      return _i23.MaterialPageX<dynamic>(
          routeData: routeData,
          child: const _i9.CustomArticlePracticeSentenceIndexPage());
    },
    VocabularyTestIndexRoute.name: (routeData) {
      return _i23.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i10.VocabularyTestIndexPage());
    },
    VocabularyTestQuestingRoute.name: (routeData) {
      final args = routeData.argsAs<VocabularyTestQuestingRouteArgs>();
      return _i23.MaterialPageX<dynamic>(
          routeData: routeData,
          child: _i11.VocabularyTestQuestingPage(
              key: args.key,
    ...
    VocabularyTestReportRoute.name: (routeData) {
      ...
      return _i23.MaterialPageX<dynamic>(
          routeData: routeData,
          child: _i12.VocabularyTestReportPage(
              key: args.key,
              vocabularyTestQuestionList: args.vocabularyTestQuestionList,
    ...
    LearningAutoGenericRoute.name: (routeData) {
      ...
      return _i23.MaterialPageX<dynamic>(
          routeData: routeData,
          child: _i13.LearningAutoGenericPage(
              key: args.key,
              contentList: args.contentList,
    ...
    LearningAutoGenericSummaryReportRoute.name: (routeData) {
      ...
      return _i23.MaterialPageX<dynamic>(
          routeData: routeData,
          child: _i14.LearningAutoGenericSummaryReportPage(
    ...
    LearningAutoMinimalPairRoute.name: (routeData) {
      ...
      return _i23.MaterialPageX<dynamic>(
          routeData: routeData,
          child: _i15.LearningAutoMinimalPairPage(
              key: args.key,
              IPA1: args.IPA1,
              IPA2: args.IPA2,
              word: args.word));
    ...
    LearningManualCustomArticlePracticeSentenceRoute.name: (routeData) {
      ...
      return _i23.MaterialPageX<dynamic>(
          routeData: routeData,
          child: _i16.LearningManualCustomArticlePracticeSentencePage(
              key: args.key,
    ...
    LearningManualMinimalPairRoute.name: (routeData) {
      ...
      return _i23.MaterialPageX<dynamic>(
          routeData: routeData,
          child: _i17.LearningManualMinimalPairPage(
              key: args.key,
              IPA1: args.IPA1,
              IPA2: args.IPA2,
              word: args.word));
    ...
    LearningManualVocabularyPracticeSentenceRoute.name: (routeData) {
      ...
      return _i23.MaterialPageX<dynamic>(
          routeData: routeData,
          child: _i18.LearningManualVocabularyPracticeSentencePage(
              key: args.key,
    ...
    SentenceAnalysisIndexRoute.name: (routeData) {
      ...
      return _i23.MaterialPageX<dynamic>(
          routeData: routeData,
          child: _i22.SentenceAnalysisIndexPage(
  ...
  List<_i23.RouteConfig> get routes => [
        ...
        _i23.RouteConfig(LearningAutoChatTopicRoute.name,
        ...
        _i23.RouteConfig(LearningAutoGenericSummaryReportRoute.name,
            path: '/learnig_auto_generic_summary_report'),
        _i23.RouteConfig(LearningAutoMinimalPairRoute.name,
            path: '/learnig_auto_minimal_pair'),
        _i23.RouteConfig(LearningManualCustomArticlePracticeSentenceRoute.name,
            path: '/learning_manual_custom_article_practice_sentence'),
        _i23.RouteConfig(LearningManualMinimalPairRoute.name,
            path: '/learning_manual_minimal_pair'),
        _i23.RouteConfig(LearningManualVocabularyPracticeSentenceRoute.name,
        ...
        _i23.RouteConfig(SentenceAnalysisIndexRoute.name,
...
class ChatTopicPracticeConversationListRoute
    extends _i23.PageRouteInfo<ChatTopicPracticeConversationListRouteArgs> {
  ChatTopicPracticeConversationListRoute(
      {_i24.Key? key, required String topicName})
...
class ChatTopicPracticeIndexRoute extends _i23.PageRouteInfo<void> {
...
/// generated route for
/// [_i5.LearningAutoChatTopicPage]
class LearningAutoChatTopicRoute
    extends _i23.PageRouteInfo<LearningAutoChatTopicRouteArgs> {
...
/// generated route for
/// [_i9.CustomArticlePracticeSentenceIndexPage]
...
/// generated route for
/// [_i11.VocabularyTestQuestingPage]
...
/// generated route for
/// [_i14.LearningAutoGenericSummaryReportPage]
class LearningAutoGenericSummaryReportRoute
    extends _i23.PageRouteInfo<LearningAutoGenericSummaryReportRouteArgs> {
  LearningAutoGenericSummaryReportRoute(
      {_i24.Key? key, required Map<dynamic, dynamic> summaryReportData})
...
/// generated route for
/// [_i15.LearningAutoMinimalPairPage]
class LearningAutoMinimalPairRoute
    extends _i23.PageRouteInfo<LearningAutoMinimalPairRouteArgs> {
...
/// generated route for
/// [_i16.LearningManualCustomArticlePracticeSentencePage]
class LearningManualCustomArticlePracticeSentenceRoute extends _i23
...
/// generated route for
/// [_i17.LearningManualMinimalPairPage]
class LearningManualMinimalPairRoute
    extends _i23.PageRouteInfo<LearningManualMinimalPairRouteArgs> {
...
/// generated route for
/// [_i18.LearningManualVocabularyPracticeSentencePage]
class LearningManualVocabularyPracticeSentenceRoute extends _i23
...
/// generated route for
/// [_i22.SentenceAnalysisIndexPage]
class SentenceAnalysisIndexRoute
    extends _i23.PageRouteInfo<SentenceAnalysisIndexRouteArgs> {
  SentenceAnalysisIndexRoute({_i24.Key? key, required String analysisor})
