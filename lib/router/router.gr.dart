...
import '../page/index/index_vocabulary_test_level_select_page.dart' as _i15;
import '../page/index/index_vocabulary_test_questing_page.dart' as _i16;
...
class AppRouter extends _i17.RootStackRouter {
  ...
  List<_i17.RouteConfig> get routes => [
        _i17.RouteConfig(SignInRoute.name, path: '/'),
        _i17.RouteConfig(IndexRoute.name, path: '/index'),
        _i17.RouteConfig(VocabularyPracticeSentenceIndexRoute.name,
            path: '/voabulary_practice_sentence_index'),
        _i17.RouteConfig(VocabularyPracticeSentenceLearnAutoRoute.name,
            path: '/voabulary_practice_sentence_auto'),
        _i17.RouteConfig(VocabularyPracticeSentenceLearnManualRoute.name,
            path: '/voabulary_practice_sentence_manual'),
        _i17.RouteConfig(VocabularyPracticeWordIndexRoute.name,
            path: '/voabulary_practice_word_index'),
        _i17.RouteConfig(VocabularyPracticeWordLearnAutoRoute.name,
            path: '/voabulary_practice_word_auto'),
        _i17.RouteConfig(VocabularyPracticeWordLearnManualRoute.name,
            path: '/voabulary_practice_word_manual'),
        _i17.RouteConfig(MinimalPairIndexRoute.name,
            path: '/minimal_pair_index'),
        _i17.RouteConfig(MinimalPairLearnAutoRoute.name,
            path: '/minimal_pair_auto'),
        _i17.RouteConfig(MinimalPairLearnManualRoute.name,
            path: '/minimal_pair_manual'),
        _i17.RouteConfig(CustomArticlePracticeSentenceIndexRoute.name,
            path: '/customArticle_practice_sentence_index'),
        _i17.RouteConfig(CustomArticlePracticeSentenceLearnAutoRoute.name,
            path: '/customArticle_practice_sentence_auto'),
        _i17.RouteConfig(CustomArticlePracticeSentenceLearnManualRoute.name,
            path: '/customArticle_practice_sentence_manual'),
        _i17.RouteConfig(IndexVocabularyTestLevelSelectRoute.name,
            path: '/vocabulary_test_select_level'),
        _i17.RouteConfig(IndexVocabularyTestQuestingRoute.name,
...
class VocabularyPracticeSentenceIndexRoute extends _i17.PageRouteInfo<void> {
...
class VocabularyPracticeSentenceLearnAutoRoute
    extends _i17.PageRouteInfo<VocabularyPracticeSentenceLearnAutoRouteArgs> {
...
class VocabularyPracticeSentenceLearnManualRoute
    extends _i17.PageRouteInfo<VocabularyPracticeSentenceLearnManualRouteArgs> {
  VocabularyPracticeSentenceLearnManualRoute(
      {_i19.Key? key, String topicClass = '', String topicName = ''})
...
class VocabularyPracticeWordIndexRoute extends _i17.PageRouteInfo<void> {
...
class VocabularyPracticeWordLearnAutoRoute
    extends _i17.PageRouteInfo<VocabularyPracticeWordLearnAutoRouteArgs> {
  VocabularyPracticeWordLearnAutoRoute({_i19.Key? key, required String word})
...
class VocabularyPracticeWordLearnManualRoute
    extends _i17.PageRouteInfo<VocabularyPracticeWordLearnManualRouteArgs> {
  VocabularyPracticeWordLearnManualRoute({_i19.Key? key, required String word})
...
class MinimalPairIndexRoute extends _i17.PageRouteInfo<void> {
...
class MinimalPairLearnAutoRoute
    extends _i17.PageRouteInfo<MinimalPairLearnAutoRouteArgs> {
  MinimalPairLearnAutoRoute(
      {_i19.Key? key, String IPA1 = '', String IPA2 = '', String word = ''})
...
class MinimalPairLearnManualRoute
    extends _i17.PageRouteInfo<MinimalPairLearnManualRouteArgs> {
...
class CustomArticlePracticeSentenceIndexRoute extends _i17.PageRouteInfo<void> {
...
class CustomArticlePracticeSentenceLearnAutoRoute extends _i17
    .PageRouteInfo<CustomArticlePracticeSentenceLearnAutoRouteArgs> {
  CustomArticlePracticeSentenceLearnAutoRoute(
      {_i19.Key? key, required List<dynamic> questionList})
...
class CustomArticlePracticeSentenceLearnManualRoute extends _i17
...
class IndexVocabularyTestLevelSelectRoute extends _i17.PageRouteInfo<void> {
...
class IndexVocabularyTestQuestingRoute extends _i17.PageRouteInfo<void> {
