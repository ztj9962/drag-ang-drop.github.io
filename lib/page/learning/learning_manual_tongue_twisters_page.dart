...
class LearningManualTongueTwistersPage extends StatefulWidget {
  ...
  @override
  _LearningManualTongueTwistersPage createState() =>
      _LearningManualTongueTwistersPage();
}

enum TtsState { playing, stopped, paused, continued }

class _LearningManualTongueTwistersPage extends State<LearningManualTongueTwistersPage> {
                            ...
                            child: Row(
                              children: <Widget>[
                                ...
                                Expanded(
                                    flex: 1,
                                    child: Visibility(
                                      visible: _testIndex < _sentence.length - 1,
                                      child: Column(
                                        mainAxisAlignment: MainAxisAlignment.center,
                                        children: [
                                          Center(
  ...
  Future<void> initLearningManualTongueTwistersPage() async {
    await initTts();
