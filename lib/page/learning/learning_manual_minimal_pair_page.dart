...
class LearningManualMinimalPairPage extends StatefulWidget {
  ...
  const LearningManualMinimalPairPage(
      {Key? key, this.IPA1 = '', this.IPA2 = '', this.word = ''})
      : super(key: key);

  @override
  _LearningManualMinimalPairPageState createState() =>
      _LearningManualMinimalPairPageState();
}

enum TtsState { playing, stopped, paused, continued }

class _LearningManualMinimalPairPageState
    extends State<LearningManualMinimalPairPage> {
  String _IPA1 = '';
  String _IPA2 = '';
  String _word = '';
  ...
  Future<void> getTestQuestions(
    ...
    if (questionText == '') {
      ...
      if (_IPA1 != '' && _IPA2 != '') {
        ...
        String sentenceContent = minimalPairTwoFinder['data'][_random]
                ['leftWord'] +
            ', ' +
      ...
      if (_word != '') {
        ...
        String sentenceContent = minimalPairWordFinder['data'][_random]
                ['leftWord'] +
            ', ' +
