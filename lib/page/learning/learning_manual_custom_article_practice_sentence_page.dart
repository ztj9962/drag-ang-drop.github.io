...
class LearningManualCustomArticlePracticeSentencePage extends StatefulWidget {
  ...
  const LearningManualCustomArticlePracticeSentencePage(
      {Key? key, required this.questionList, required this.questionIPAList})
      : super(key: key);

  @override
  _LearningManualCustomArticlePracticeSentencePage createState() =>
      _LearningManualCustomArticlePracticeSentencePage();
}

enum TtsState { playing, stopped, paused, continued }

class _LearningManualCustomArticlePracticeSentencePage
    extends State<LearningManualCustomArticlePracticeSentencePage> {
  ...
  void initState() {
    ...
    _questionIPAList = widget.questionIPAList;
  ...
  void _responseChatBot(text) async {
    setState(() {
      ...
      _allowTouchButtons['beforeButton'] = false;
    });
...
//
  ...
  Future<void> getTestQuestions(
    ...
    if (questionText == '') {
      ...
      getTestQuestions(
          questionText: _questionList[questionIndex],
          questionIPAText: _questionIPAList[questionIndex],
          questionChineseText: "");
      return;
    }
