...
class _CustomArticlePracticeSentenceLearnManualPage extends State<CustomArticlePracticeSentenceLearnManualPage> {
  ...
  String _questionText = 'How about you';
                                          ...
                                          Center(
                                            child: CircleAvatar(
                                              ...
                                              child: IconButton(
                                                ...
                                                color: (_allowTouchButtons['beforeButton']! ) ? Colors.white : Colors.grey ,
                                                onPressed: () {
                                                  if(_allowTouchButtons['beforeButton']!){
                                                    questionIndex-=1;
                                                    _ttsStop();
                                                    sttStopListening();
                                                    getTestQuestions();
...
//
  ...
  Future<void> getTestQuestions({String questionText = '', String questionIPAText = '', String questionChineseText = '', String aboutWord = ''}) async {
    if(questionText == ''){
      ...
      getTestQuestions(questionText: _questionList[questionIndex], questionIPAText: _questionIPAList[questionIndex], questionChineseText: "");
      return;
    }
