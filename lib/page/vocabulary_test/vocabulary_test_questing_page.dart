...
class VocabularyTestQuestingPage extends StatefulWidget {
  ...
  const VocabularyTestQuestingPage(
      {Key? key, required this.vocabularyTestQuestionList})
      : super(key: key);

  @override
  _VocabularyTestQuestingPage createState() => _VocabularyTestQuestingPage();
}
...
class _VocabularyTestQuestingPage extends State<VocabularyTestQuestingPage> {
              ...
              Padding(
                  ...
                  child: Container(
                    child: OutlinedButton(
                      ...
                      onPressed: () {
                        _chooseAnswer(_vocabularyTestQuestionList[_part]
                            ['selectionList'][0]);
                      },
                    ),
                  )),
  ...
  void _chooseAnswer(chooseAnswer) {
    ...
    if (_chooseAnswerList.length == _vocabularyTestQuestionList.length) {
      ...
      AutoRouter.of(context).replace(VocabularyTestReportRoute(
          vocabularyTestQuestionList: _vocabularyTestQuestionList,
          chooseAnswerList: _chooseAnswerList));
