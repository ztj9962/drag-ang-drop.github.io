...
class VocabularyTestReportPage extends StatefulWidget {
  ...
  const VocabularyTestReportPage ({ Key? key, required this.vocabularyTestQuestionList, required this.chooseAnswerList }): super(key: key);

  @override
  _VocabularyTestReportPage createState() =>
      _VocabularyTestReportPage();
}
                                      ...
                                      Padding(
                                        ...
                                        child: AutoSizeText(
                                          ...
                                          style: TextStyle(
                                            fontSize: 20,
                                            //color: PageTheme.app_theme_blue,
                                            color: (_chooseAnswerList[index] == _vocabularyTestQuestionList[index]['answer']) ? Colors.green : Colors.red,
                                          ),
                                        ),
                                      ),
                                    ]
